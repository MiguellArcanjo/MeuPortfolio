...
export function Contact() {
    ...
    return (
        <section className={`${isDarkMode ? "dark-modeContainer-contact" : "container-contact"}`} id="contato">
            ...
            <div className="containerContacts">
                <div>
                    <a href="" className="testeIcon" target="blank_">
                ...
                <div>
                    <a href="https://github.com/MiguellArcanjo" className="testeIcon" target="blank_">
                ...
                <div>
                    <a href="https://www.linkedin.com/in/miguel-arcanjob/" className="testeIcon" target="blank_">
